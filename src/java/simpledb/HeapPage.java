...
public class HeapPage implements Page {
    ...
    */
    ...
    public void deleteTuple(Tuple t) throws DbException {
    	...
    	int _tupleno = t.getRecordId().tupleno();
    	if(!isSlotUsed(_tupleno))
    		throw new DbException("tuple slot is already empty");
    	markSlotUsed(_tupleno, false);
    	tuples[_tupleno] = null;
    ...
    private void markSlotUsed(int i, boolean value) {
    	...
    	int pos = i % 8;
    	if(value)
    		header[ithHead] = (byte) (header[ithHead] | (1 << pos));
    	else
    		header[ithHead] = (byte) (header[ithHead] & ~(1 << pos));
    ...
    class TupleIterator implements Iterator<Tuple>
    {
    	...
    	public Tuple next() 
    	{
    		if(hasNext())
    		{
        		while(index < numSlots && tuples[index] == null)
        			index++;
        		index++;
