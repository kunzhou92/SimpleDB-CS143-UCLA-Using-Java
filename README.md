...
SimpleDB was written in Java. A set of mostly unimplemented classes and interfaces were provided. I wrote the code for these classes. The Java class files are saved in the directory _/src/java/simpledb_ 
